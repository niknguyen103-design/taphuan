...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Văn Kín - Trường tiểu học Khuôn Hà - ĐT: 0972 260 965</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Văn Kín - Trường tiểu học Khuôn Hà - ĐT: 0972 260 965</div>", unsafe_allow_html=True)
